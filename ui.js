var ui = new Vue({
  data: {code: null, platform: platform, client: client, step: 1, directoryMessage: 'Click "Browse"', firstTime: true, titleOpacity: 0, subtitleOpacity: 0, actionOpacity: 0, devices: []},
  el: "#app",
  methods: {
    close(){
      window.close()
